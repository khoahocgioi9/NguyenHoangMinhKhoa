...
public class Question_of_Quiz_Frame extends JFrame implements ActionListener {
	JButton b1, b2, b3, b4, btnBack;
	// final int type;
	String s[];

	Question_of_Quiz_Frame(int type) {
		s = (SW.getInstance()).quiz(type);
		// A Label
		...
		if (type == 1)
			questionLabel = new JLabel("Slang " + "`" + s[0] + "`" + " means to: ");
		else
			questionLabel = new JLabel("`" + s[0] + "`" + " have slang word :");
